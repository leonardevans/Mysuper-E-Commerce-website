...
?>
            ...
            <div class="nav-bottom">
                ...
                <a class="page-links active">Locations</a>
        ...
        <aside>
            ...
            <div class="dashboard-page-link dpl-active"><a><i class="fa fa-map-marker"></i>Locations</a><span
        ...
        <div class="contents">
            <h5 class="contents-header">Locations</h5>
            <div class="contents-holder">

                <div class="list-locations">
                    <input type="button" style="float: right;" value="Add New" class="btn btn-success" id="add-btn" />
                    <table class="table table-striped table-hover table-bordered locations-table">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Options</th>
                ...
                <div class="add-location">
                    ...
                    <form action="" id="addForm">
                        ...
                        <div class="form-group">
                            <input type="button" value="Add" class="btn btn-success" id="submit-location-btn" />
                            <input type="button" value="Update" class="btn btn-success" id="update-location-btn"
                                style="display:none" />
                        </div>
                    </form>
                </div>
