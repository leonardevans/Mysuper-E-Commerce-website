...
?>
            ...
            <div class="nav-bottom">
                ...
                <a class="page-links active">Customers</a>
            </div>
        </header>
        <aside>
            <h5>Dashboard</h5>
            ...
            <div class="dashboard-page-link dpl-active"><a><i class="fa fa-users"></i>Customers</a><span
                    class="total-customers">346</span></div>
        </aside>
        <div class="contents">
            <h5 class="contents-header">Customers</h5>
            <div class="contents-holder">

                <div class="list-customers">

                    <table class="table table-striped table-hover table-bordered customers-table">
                        <thead>
                            <tr>
                                <th>Username</th>
                                <th>Email</th>
