...
?>
            ...
            <div class="nav-bottom">
                ...
                <a class="page-links active">Stores</a>
        ...
        <aside>
            ...
            <div class="dashboard-page-link dpl-active"><a><i class="fa fa-building"></i>Stores</a><span
                ...
                <div class="add-store">
                    ...
                    <form action="" id="addForm">
                        <div class="form-group">
                            <input type="text" name="store" id="store-name" placeholder="STORE NAME"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="location">Location</label>
                            <select name="location" id="store-location" class="form-control">

                            </select>
                        </div>
                        <div class="form-group">
                            <input type="button" value="Add" id="add-store" class="btn btn-success">
                            <input type="button" value="Update" id="update-store" class="btn btn-success"
                                style="display:none">
                        </div>
                    </form>
                </div>
